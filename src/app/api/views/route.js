// ─────────────────────────────────────────────────────────────────────
//  /api/views  — page view counters per website
//
//  POST  → increment the view counter (api-key protected, public)
//  GET   → list view counters       (api-key protected, public)
//
...
import { recordView, listViews } from "@/lib/store";
...
// Body: { websiteUrl, websiteName?, amount? }
export async function POST(req) {
  ...
  return NextResponse.json(
    { ok: true, message: "View recorded", ...result },
